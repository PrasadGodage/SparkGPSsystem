<?php
	...
	{
		 $query = mysqli_query($conn,"select * from users where emailid='$emailid'");
			if($query!=null)
			{
			...
			$records;
				if($affected>0)
				{
					...
					{
					$records=$result['emailid'];


$to      = $result['emailid'];
$subject = 'Password recovery from Banyan Bazar';
...
:solid 1px #ccc; width:600px;">
        <tr>
            <td height="40" align="left" valign="middle" bgcolor="#000" style="border-bottom:solid 1px #ccc;">
                <table border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                            <td align="right" class="headlogo" valign="bottom" style="padding-left:10px;"><img src="http://app.banyanbazar.com/src/img/bb.jpg" border="0" />
                            </td>
                        </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="left" valign="top" style="padding-left:20px; padding-top:10px; color:#363636; padding-bottom:15px; line-height:12px; font-size:14px; padding-right:20px; font-family:Arial, Helvetica, sans-serif;">
                Your password for Banyan Bazar application is : '.$result['password'].'
            </td>
        </tr>
        ...
        <tr>
                <td align="left" valign="top" style="padding:10px 15px; background:#3B4851; font-family:Arial, Helvetica, sans-serif; color:#fff; font-size:14px;">&copy; '.date("Y").' RaY app All rights reserved</td>
              </tr>
    </table>
</body>
</html>';
...
$headers .= 'From:banyanbazar@gmail.com' . "\r\n";
